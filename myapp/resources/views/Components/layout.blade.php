            ...
            <div class="relative ml-3">
              <div>
                <button type="button" class="relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800 focus:outline-hidden" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                  ...
                  <img class="size-8 rounded-full" src="https://cdn.rafled.com/anime-icons/images/0a7260556e12b025bd05cb02dff0fa28e0cda09ce5ba4724caa1901c366328c0.jpg" alt="">
                </button>
              </div>
            </div>
          </div>
    ...
    <div class="md:hidden" id="mobile-menu">
      ...
      <div class="border-t border-gray-700 pt-4 pb-3">
        <div class="flex items-center px-5">
          <div class="shrink-0">
            <img class="size-10 rounded-full" src="https://cdn.rafled.com/anime-icons/images/0a7260556e12b025bd05cb02dff0fa28e0cda09ce5ba4724caa1901c366328c0.jpg" alt="">
          </div>
          <div class="ml-3">
  ...
  <header class="bg-white shadow-sm">
    ...
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 sm:flex sm:justify-between">
      ...
      @if (!request()->is('jobs/create'))
        <a href="/jobs/create" class="inline-block rounded-md bg-indigo-600 px-4 py-2 text-sm font-semibold text-white shadow-md hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:ring-offset-2">
          Create Job
      </a>
      @endif
    </div>
